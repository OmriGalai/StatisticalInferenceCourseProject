...
g <- g + stat_function(fun = dnorm, args = list(mean = mean(means), sd = sd(means)), colour = "red")
g <- g + labs(title = "Histogram of sample means and normal density") + theme(title = element_text(size = 8))
